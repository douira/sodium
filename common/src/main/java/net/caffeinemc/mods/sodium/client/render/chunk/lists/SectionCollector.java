...
public abstract class SectionCollector implements RenderListProvider, RenderSectionVisitor {
    ...
    private final EnumMap<ChunkUpdateType, ArrayDeque<RenderSection>> sortedTaskLists;
    ...
    public void visit(RenderSection section) {
        ...
        if (type != null && section.getTaskCancellationToken() == null) {
            Queue<RenderSection> queue = this.sortedTaskLists.get(type);
    ...
    @Override
    public Map<ChunkUpdateType, ArrayDeque<RenderSection>> getTaskLists() {
