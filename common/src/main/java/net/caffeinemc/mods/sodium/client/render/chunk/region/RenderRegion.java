...
public class RenderRegion {
    ...
    private final ChunkUpdateType[] sectionPendingUpdates = new ChunkUpdateType[RenderRegion.REGION_SIZE];
    ...
    public void setSectionPendingUpdate(int id, ChunkUpdateType type) {
        this.sectionPendingUpdates[id] = type;
    }

    public ChunkUpdateType getSectionPendingUpdate(int id) {
