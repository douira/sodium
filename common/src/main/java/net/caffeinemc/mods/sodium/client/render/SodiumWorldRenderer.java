...
public class SodiumWorldRenderer {
    ...
    public void setupTerrain(Camera camera,
        ...
        for (int i = 0; i < maxChunkUpdates; i++) {
            ...
            // TODO: reordering of this to avoid needing to patch immediate presentation into the render list and instead insert into the tree directly before it gets traversed?
